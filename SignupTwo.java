...
//        setLayout(null);
//       
//        setTitle("NEW ACCOUNT APPLICATION FORM NO - PAGE 2");
//        
...
//        add(marital);
//        
//        String occupationValues[] = {"Salaried", "Seld-Employed", "Buisness", "Student","Retired", "Others"};
...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    public static void main(String args[]){
       new SignupTwo("1234"); // Ensure to pass a form number or generate it in the constructor
    }
}
